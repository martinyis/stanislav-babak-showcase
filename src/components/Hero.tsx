    ...
    >
      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto text-center md:text-left">
          ...
          <h2
            className="text-xl sm:text-2xl md:text-3xl font-medium text-foreground/90 mb-6 md:mb-8 animate-fade-in"
          ...
          <p
            className="text-base md:text-lg text-foreground/70 mb-8 md:mb-10 animate-fade-in"
          ...
          >
            ...
            <span className="text-accent font-medium"> React</span>. Passionate
            about building elegant, efficient and user-centered solutions.
          </p>

          <div
            className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center md:justify-start animate-fade-in"
